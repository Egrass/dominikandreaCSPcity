...
if C.offset:
    ...
    out_path = '/home/xwj/CSPoutput/valresults/city/%s/off2camms11' % (C.scale)

if not os.path.exists(out_path):
    os.makedirs(out_path)
files = sorted(os.listdir(w_path))
# get the results from epoch 51 to epoch 150
for w_ind in range(117, 120,1):
    for f in files:
    ...
    for f in range(num_imgs):
        ...
        if C.offset:
            ...
            boxes = bbox_process.parse_det_offset_ms4maxcls(Y, C, score=0.01, down=4)
        else:
