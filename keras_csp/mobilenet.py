...
def nn_p3(img_input=None, alpha=1.0, depth_multiplier=1,  trainable=True):
    x = _conv_block(img_input, 32, alpha, strides=(2, 2), trainable=False)
    x = _depthwise_conv_block(x, 64, alpha, depth_multiplier, block_id=1, trainable=False)
...
def nn_p4(img_input=None, alpha=1.0, depth_multiplier=1,  trainable=True):
    x = _conv_block(img_input, 32, alpha, strides=(2, 2), trainable=False)
    x = _depthwise_conv_block(x, 64, alpha, depth_multiplier, block_id=1, trainable=False)
...
def nn_p5(img_input=None, alpha=1.0, depth_multiplier=1,  trainable=True):
    x = _conv_block(img_input, 32, alpha, strides=(2, 2), trainable=False)
    x = _depthwise_conv_block(x, 64, alpha, depth_multiplier, block_id=1, trainable=False)
...
def nn_p3p4_featcam(img_input=None, alpha=1.0, depth_multiplier=1,  trainable=True):
    x = _conv_block(img_input, 32, alpha, strides=(2, 2), trainable=False)
    x = _depthwise_conv_block(x, 64, alpha, depth_multiplier, block_id=1, trainable=False)
    ...
    cam3 = CAM(axis=3, name='cam3')(feat)
...
def nn_p4p5_featcam(img_input=None, alpha=1.0, depth_multiplier=1,  trainable=True):
    x = _conv_block(img_input, 32, alpha, strides=(2, 2), trainable=False)
    x = _depthwise_conv_block(x, 64, alpha, depth_multiplier, block_id=1, trainable=False)
...
def nn_p3p4p5_featcam(img_input=None, alpha=1.0, depth_multiplier=1,  trainable=True):
    x = _conv_block(img_input, 32, alpha, strides=(2, 2), trainable=False)
    x = _depthwise_conv_block(x, 64, alpha, depth_multiplier, block_id=1, trainable=False)
...
def nn_p3p5(img_input=None, alpha=1.0, depth_multiplier=1,  trainable=True):
    x = _conv_block(img_input, 32, alpha, strides=(2, 2), trainable=False)
    x = _depthwise_conv_block(x, 64, alpha, depth_multiplier, block_id=1, trainable=False)
