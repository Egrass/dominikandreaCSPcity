...
if C.network == 'resnet50':
    ...
    #weight_path = '/home/xwj/CSPoutput/valmodels/city/h/off2cam/net_e42_l0.0120742626729.hdf5'
if C.offset:
    out_path = '/home/xwj/CSPoutput/valmodels/city/%s/off2cam1024' % (C.scale)
...
preds = nn.nn_p3p4p5can(img_input, offset=C.offset, num_scale=C.num_scale, trainable=True)
preds_tea = nn.nn_p3p4p5can(img_input, offset=C.offset, num_scale=C.num_scale, trainable=True)
