...
if C.offset:
    out_path = '/home/xwj/CSPoutput/valmodels/city/%s/off21024' % (C.scale)
...
preds_tea = nn.nn_p3p4p5cls(img_input, offset=C.offset, num_scale=C.num_scale, trainable=True)
...
if C.offset:
    model.compile(optimizer=optimizer, loss=[losses.cls_center])
